...
class Barang extends CI_Controller{
	...
	public function index(){
		$this->data['title'] = 'Master Data Barang';
	...
	public function ubah($kode_barang){
		...
		$this->data['title'] = 'Ubah Master Data Barang';
	...
	public function proses_ubah($kode_barang){
		...
		if($this->m_barang->ubah($data, $kode_barang)){
			$this->session->set_flashdata('success', 'Master Data Barang <strong>Berhasil</strong> Diubah!');
			redirect('barang');
		} else {
	...
	public function export(){
		...
		$data ['laporan_barang'] = $this->m_barang->lihat();
