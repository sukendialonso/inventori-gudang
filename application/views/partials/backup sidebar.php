...
<?php if ($this->session->userdata['login']['role']=='user'):?>
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">INVENTORI BARANG</div>
                </a>
                ...
                <li class="nav-item <?= $aktif == 'penerimaan' ? 'active' : '' ?>">
                    <a class="nav-link" href="<?= base_url('Laporan_barang_masuk') ?>">
                        <i class="fas fa-fw fa-file-invoice"></i>
                        <span>Laporan Barang Masuk</span></a>
    
            <li class="nav-item <?= $aktif == 'pengeluaran' ? 'active' : '' ?>">
                    <a class="nav-link" href="<?= base_url('Laporan_barang_keluar') ?>">
                        <i class="fas fa-fw fa-file-invoice"></i>
            ...
            <?php elseif ($this->session->userdata['login']['role']=='admin'):?>
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">INVENTORI BARANG 456</div>
                </a>
                <hr class="sidebar-divider my-0">
                <li class="nav-item <?= $aktif == 'dashboard' ? 'active' : '' ?>">
                    <a class="nav-link" href="<?= base_url('dashboard') ?>">
