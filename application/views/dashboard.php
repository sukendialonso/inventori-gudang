			...
			<div id="content" data-url="<?= base_url('kasir') ?>">
				...
				<div class="container-fluid">
					...
					<?php 
						...
						if (@!$kode_barang){
						$cek_kode_barang = NULL;
						}else{
						$cek_kode_barang = $kode_barang;
						}
						// die();

						if ($cek_kode_barang){ ?>
										<div  class="alert alert-danger alert-dismissible fade show" role="alert">
						<h5>Perhatian ! <?php echo $nama_barang; ?> dengan kode barang <?php echo $kode_barang; ?> 
						Jumlah barang <?php echo $stok;?> </h5>
			          	...
			          	<div class="col-md-6">
							<div class="card shadow">
								...
								<div class="card-body">
									...
									<input  type="text" value="<?= $perusahaan->nama_perusahaan ?>" readonly class="form-control mt-2 mb-2">
									<strong>Nama Pemilik : </strong><br>
									<input  type="text" value="<?= $perusahaan->nama_pemilik ?>" readonly class="form-control mt-2 mb-2">
									<strong>No Telepon : </strong><br>
									<input  type="text" value="<?= $perusahaan->no_telepon ?>" readonly class="form-control mt-2 mb-2">
									<strong>Alamat : </strong><br>
									<input  type="text" value="<?= $perusahaan->alamat ?>" readonly class="form-control mt-2">
								</div>				
							</div>
			          	</div>
			          	<div class="col-md-6">
							<div class="card shadow">
								...
								<div class="card-body">
									...
									<input type="text" value="<?= $this->session->login['nip'] ?>" readonly class="form-control mt-2 mb-2">
