								...
								<form action="<?= base_url('pengeluaran/proses_tambah') ?>" id="form-tambah" method="POST">
									...
									<div class="form-row">
										...
										<div class="form-group col-3">
											...
											<input type="text" name="nip_user" value="<?= $this->session->login['nip'] ?>" readonly class="form-control">
										</div>
										<div class="form-group col-3">
											<label>Nama User</label>
											<input type="text" name="nama_user" value="<?= $this->session->login['nama'] ?>" readonly class="form-control">
										</div>
										<div class="form-group col-2">
												...
												<div class="form-group col-10">
													...
													<select name="nama" id="nama" class="form-control">
														...
														<?php foreach ($all_pengguna as $pengguna): ?>
															<option value="<?= $pengguna->nama ?>"><?= $pengguna->nama ?></option>
														<?php endforeach ?>
													</select>
												</div>
												<div class="form-group col-2">
